            ...
            <div className="LojaInfoAndHorarioFuncionamento">
                <div>
                    ...
                    <div className="LojaInfo">
                        <img className='IconLojaInfo' src={props.image} alt='Logo' />
                    ...
                    <div className="WhatsappTellAlterarLoja">
                        ...
                        <Link to="/lojas" className="AlterarLoja">
                ...
                <div className="HorarioFuncionamento">
                    <div className='HF'><p>Segunta</p><p className='pontS'>{".".repeat(36)}</p><p>{props.SegundaASextaI}h até {props.SegundaASextaF}h</p></div>
                    <div className='HF'><p>Terça</p><p className='pontS'>{".".repeat(41)}</p><p>{props.SegundaASextaI}h até {props.SegundaASextaF}h</p></div>
                    <div className='HF'><p>Quarta</p><p className='pontS'>{".".repeat(38)}</p><p>{props.SegundaASextaI}h até {props.SegundaASextaF}h</p></div>
                    <div className='HF'><p>Quinta</p><p className='pontS'>{".".repeat(39)}</p><p>{props.SegundaASextaI}h até {props.SegundaASextaF}h</p></div>
                    <div className='HF'><p>Sexta</p><p className='pontS'>{".".repeat(41)}</p><p>{props.SegundaASextaI}h até {props.SegundaASextaF}h</p></div>
                    <div className='HF'><p>Sábado</p><p className='pontS'>{".".repeat(37)}</p><p>{props.SabadoI}h até {props.SabadoF}h</p></div>
                    <div className='HF'><p>Domingo</p><p className='pontS'>{".".repeat(35)}</p><p>{props.DomingoI}h até {props.DomingoF}h</p></div>
                </div>
            </div>
            <br />
