        ...
        <nav className='menu'>
            <div>
                ...
                <ul className='menuDesktop'>
                    ...
                    <Link to="/TransferenciaEntreLojas" className={(location.pathname.startsWith("/TransferenciaEntreLojas") || location.pathname.startsWith("/RelatorioTransferenciaEntreLoja")) ? "active" : ""}>
